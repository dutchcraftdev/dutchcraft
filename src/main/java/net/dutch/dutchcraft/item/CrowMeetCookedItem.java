...
public class CrowMeetCookedItem extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:crow_meet_cooked")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(DUTCHCRAFTItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(8).saturation(0.4f)

							.meat().build()));
			setRegistryName("crow_meet_cooked");
		}
