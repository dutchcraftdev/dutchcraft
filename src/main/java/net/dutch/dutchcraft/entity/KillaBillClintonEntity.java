...
import net.dutch.dutchcraft.entity.renderer.KillaBillClintonRenderer;
import net.dutch.dutchcraft.DutchcraftModElements;

import java.util.Random;

@DutchcraftModElements.ModElement.Tag
public class KillaBillClintonEntity extends DutchcraftModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -65536, -16776961, new Item.Properties().group(DUTCHCRAFTItemGroup.tab))
				.setRegistryName("killa_bill_clinton_spawn_egg"));
	}
