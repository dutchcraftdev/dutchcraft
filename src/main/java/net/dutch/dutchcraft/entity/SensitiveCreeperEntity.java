...
import net.dutch.dutchcraft.procedures.SensitiveCreeperRightClickedOnEntityProcedure;
import net.dutch.dutchcraft.procedures.SensitiveCreeperExplodeInSunlightProcedure;
import net.dutch.dutchcraft.itemgroup.DUTCHCRAFTItemGroup;
import net.dutch.dutchcraft.entity.renderer.SensitiveCreeperRenderer;
...
public class SensitiveCreeperEntity extends DutchcraftModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -205, -16764109, new Item.Properties().group(DUTCHCRAFTItemGroup.tab))
				.setRegistryName("sensitive_creeper_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreeperEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			SensitiveCreeperRightClickedOnEntityProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			SensitiveCreeperExplodeInSunlightProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z), new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
