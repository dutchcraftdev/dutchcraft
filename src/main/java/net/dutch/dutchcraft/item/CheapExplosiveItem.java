...
import net.dutch.dutchcraft.entity.renderer.CheapExplosiveRenderer;
...
public class CheapExplosiveItem extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:cheap_explosive")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(DUTCHCRAFTItemGroup.tab).maxStackSize(64));
			setRegistryName("cheap_explosive");
		}
		...
		public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
			...
			list.add(new StringTextComponent("WARNING: item is very broken"));
		}
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 0.8f, 2, 5);
					itemstack.damageItem(1, entity, e -> e.sendBreakAnimation(entity.getActiveHand()));
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;

					CheapExplosiveRangedItemUsedProcedure.executeProcedure(Stream
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(CheapExplosiveItem.block);
		}
		...
		public void onEntityHit(EntityRayTraceResult entityRayTraceResult) {
			...
			CheapExplosiveProjectileHitsBlockProcedure.executeProcedure(Stream
