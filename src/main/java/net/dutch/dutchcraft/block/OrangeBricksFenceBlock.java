...
public class OrangeBricksFenceBlock extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:orange_bricks_fence")
	public static final Block block = null;

	public OrangeBricksFenceBlock(DutchcraftModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends WallBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3f, 4.5f).setLightLevel(s -> 0));
			setRegistryName("orange_bricks_fence");
		}
