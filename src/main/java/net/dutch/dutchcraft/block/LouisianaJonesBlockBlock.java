...
import net.dutch.dutchcraft.procedures.LouisianaJonesBlockOnBlockRightClickedProcedure;
...
public class LouisianaJonesBlockBlock extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:louisiana_jones_block")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("louisiana_jones_block");
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			LouisianaJonesBlockOnBlockRightClickedProcedure.executeProcedure(Stream
