...
import net.dutch.dutchcraft.entity.renderer.HomelessRenderer;
import net.dutch.dutchcraft.DutchcraftModElements;

@DutchcraftModElements.ModElement.Tag
public class HomelessEntity extends DutchcraftModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -3342388, -13108, new Item.Properties().group(DUTCHCRAFTItemGroup.tab))
				.setRegistryName("homeless_spawn_egg"));
	}

	@SubscribeEvent
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		event.getSpawns().getSpawner(EntityClassification.MONSTER).add(new MobSpawnInfo.Spawners(entity, 15, 4, 12));
	}
