...
import net.dutch.dutchcraft.procedures.UnstableBricksBlockDestroyedByPlayerProcedure;
...
public class UnstableBricksBlock extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:unstable_bricks")
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("unstable_bricks");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			UnstableBricksBlockDestroyedByPlayerProcedure.executeProcedure(Stream
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dutchcraft:unstable_bricks_match"),
			...
			event.getRegistry().register(feature.setRegistryName("unstable_bricks"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dutchcraft:unstable_bricks"), configuredFeature);
		}
	}
