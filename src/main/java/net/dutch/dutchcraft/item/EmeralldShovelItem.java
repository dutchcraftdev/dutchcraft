...
public class EmeralldShovelItem extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:emeralld_shovel")
	public static final Item block = null;

	public EmeralldShovelItem(DutchcraftModElements instance) {
		super(instance, 34);
	}
	...
	public void initElements() {
		...
		}.setRegistryName("emeralld_shovel"));
	}
}
