...
import net.dutch.dutchcraft.procedures.SpongeChickenOnEntityTickUpdateProcedure;
import net.dutch.dutchcraft.procedures.SpongeChickenEntityDiesProcedure;
import net.dutch.dutchcraft.itemgroup.DUTCHCRAFTItemGroup;
import net.dutch.dutchcraft.entity.renderer.SpongeChickenRenderer;
...
public class SpongeChickenEntity extends DutchcraftModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -256, -6711040, new Item.Properties().group(DUTCHCRAFTItemGroup.tab))
				.setRegistryName("sponge_chicken_spawn_egg"));
	}
	...
	public static class CustomEntity extends ChickenEntity {
		...
		public void onDeath(DamageSource source) {
			...
			SpongeChickenEntityDiesProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("sourceentity", sourceentity))
		...
		public void baseTick() {
			...
			SpongeChickenOnEntityTickUpdateProcedure.executeProcedure(Stream
