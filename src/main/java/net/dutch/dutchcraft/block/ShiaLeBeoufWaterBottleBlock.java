...
import net.dutch.dutchcraft.procedures.ShiaLeBeoufWaterBottleUpdateTickProcedure;
...
public class ShiaLeBeoufWaterBottleBlock extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:shia_le_beouf_water_bottle")
	public static final Block block = null;

	public ShiaLeBeoufWaterBottleBlock(DutchcraftModElements instance) {
		super(instance, 26);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("shia_le_beouf_water_bottle");
		}
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 0, 0, 16, 24, 16))
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			ShiaLeBeoufWaterBottleUpdateTickProcedure.executeProcedure(Stream
