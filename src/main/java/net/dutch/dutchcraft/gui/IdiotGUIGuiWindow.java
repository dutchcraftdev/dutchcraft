...
@OnlyIn(Dist.CLIENT)
public class IdiotGUIGuiWindow extends ContainerScreen<IdiotGUIGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = IdiotGUIGui.guistate;
	TextFieldWidget final_words;

	public IdiotGUIGuiWindow(IdiotGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("dutchcraft:textures/screens/idiot_gui.png");
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		final_words = new TextFieldWidget(this.font, this.guiLeft + 157, this.guiTop + 135, 120, 20, new StringTextComponent(""));
