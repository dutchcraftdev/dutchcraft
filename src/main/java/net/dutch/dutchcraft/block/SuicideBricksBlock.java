...
import net.dutch.dutchcraft.procedures.SuicideBricksUpdateTickProcedure;
...
public class SuicideBricksBlock extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:suicide_bricks")
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			SuicideBricksUpdateTickProcedure.executeProcedure(Stream
