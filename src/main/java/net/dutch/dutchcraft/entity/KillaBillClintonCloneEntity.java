...
package net.dutch.dutchcraft.entity;
...
import net.dutch.dutchcraft.entity.renderer.KillaBillClintonCloneRenderer;
import net.dutch.dutchcraft.DutchcraftModElements;

import java.util.Random;

@DutchcraftModElements.ModElement.Tag
public class KillaBillClintonCloneEntity extends DutchcraftModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("killa_bill_clinton_clone").setRegistryName("killa_bill_clinton_clone");

	public KillaBillClintonCloneEntity(DutchcraftModElements instance) {
		super(instance, 81);
		FMLJavaModLoadingContext.get().getModEventBus().register(new KillaBillClintonCloneRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16724788, -6750106, new Item.Properties().group(DUTCHCRAFTItemGroup.tab))
				.setRegistryName("killa_bill_clinton_clone_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 10;
			setNoAI(false);
			this.setItemStackToSlot(EquipmentSlotType.MAINHAND, new ItemStack(Items.WOODEN_SHOVEL));
		}
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, LucasOReileyEntity.CustomEntity.class, false, false));
			this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, LucasOReileyCloneEntity.CustomEntity.class, false, false));
		}
