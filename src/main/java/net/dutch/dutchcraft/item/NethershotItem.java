...
import net.dutch.dutchcraft.entity.renderer.NethershotRenderer;
...
public class NethershotItem extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:nethershot")
