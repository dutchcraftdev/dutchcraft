...
public class CrowMeetItem extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:crow_meet")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(DUTCHCRAFTItemGroup.tab).maxStackSize(64).rarity(Rarity.COMMON)
					.food((new Food.Builder()).hunger(7).saturation(0.2f)

							.meat().build()));
			setRegistryName("crow_meet");
		}
