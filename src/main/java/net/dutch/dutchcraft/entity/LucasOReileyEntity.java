...
import net.dutch.dutchcraft.entity.renderer.LucasOReileyRenderer;
import net.dutch.dutchcraft.DutchcraftModElements;

import java.util.Random;

@DutchcraftModElements.ModElement.Tag
public class LucasOReileyEntity extends DutchcraftModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10101748, -3724271, new Item.Properties().group(DUTCHCRAFTItemGroup.tab))
				.setRegistryName("lucas_o_reiley_spawn_egg"));
	}
