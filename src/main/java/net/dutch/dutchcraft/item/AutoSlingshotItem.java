...
import net.dutch.dutchcraft.entity.renderer.AutoSlingshotRenderer;
...
public class AutoSlingshotItem extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:auto_slingshot")
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			...
			setRegistryName("auto_slingshot");
		}
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ItemStack stack = ShootableItem.getHeldAmmo(entity, e -> e.getItem() == Items.BRICK);
					if (stack == ItemStack.EMPTY) {
						for (int i = 0; i < entity.inventory.mainInventory.size(); i++) {
							ItemStack teststack = entity.inventory.mainInventory.get(i);
							if (teststack != null && teststack.getItem() == Items.BRICK) {
								stack = teststack;
								break;
							}
						}
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						...
						if (entity.abilities.isCreativeMode) {
							...
							if (new ItemStack(Items.BRICK).isDamageable()) {
