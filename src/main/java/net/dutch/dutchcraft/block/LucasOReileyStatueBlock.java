...
import net.dutch.dutchcraft.procedures.LucasOReileyStatueUpdateTickProcedure;
...
public class LucasOReileyStatueBlock extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:lucas_o_reiley_statue")
	...
	public static class CustomBlock extends Block {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			LucasOReileyStatueUpdateTickProcedure.executeProcedure(Stream
