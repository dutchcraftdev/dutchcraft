...
public class CoinBlockBlock extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:coin_block")
	public static final Block block = null;

	public CoinBlockBlock(DutchcraftModElements instance) {
		super(instance, 4);
	}
