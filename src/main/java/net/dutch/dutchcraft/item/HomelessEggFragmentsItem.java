...
public class HomelessEggFragmentsItem extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:homeless_egg_fragments")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("homeless_egg_fragments");
		}
