...
import net.dutch.dutchcraft.entity.renderer.LucasOReileyCloneRenderer;
import net.dutch.dutchcraft.DutchcraftModElements;

import java.util.Random;

@DutchcraftModElements.ModElement.Tag
public class LucasOReileyCloneEntity extends DutchcraftModElements.ModElement {
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16711783, -26368, new Item.Properties().group(DUTCHCRAFTItemGroup.tab))
				.setRegistryName("lucas_o_reiley_clone_spawn_egg"));
	}
