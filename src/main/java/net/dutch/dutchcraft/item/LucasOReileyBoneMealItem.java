...
import net.dutch.dutchcraft.procedures.LucasOReileyBoneMealRightclickedOnBlockProcedure;
...
public class LucasOReileyBoneMealItem extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:lucas_o_reiley_bone_meal")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("lucas_o_reiley_bone_meal");
		}
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			LucasOReileyBoneMealRightclickedOnBlockProcedure.executeProcedure(Stream
