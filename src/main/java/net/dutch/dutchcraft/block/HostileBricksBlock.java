...
import net.dutch.dutchcraft.procedures.HostileBricksEntityWalksOnTheBlockProcedure;
...
public class HostileBricksBlock extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:hostile_bricks")
	public static final Block block = null;

	public HostileBricksBlock(DutchcraftModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("hostile_bricks");
		}
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			HostileBricksEntityWalksOnTheBlockProcedure.executeProcedure(Stream
