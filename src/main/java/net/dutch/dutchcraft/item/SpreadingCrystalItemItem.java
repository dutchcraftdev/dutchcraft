...
public class SpreadingCrystalItemItem extends DutchcraftModElements.ModElement {
	@ObjectHolder("dutchcraft:spreading_crystal_item")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("spreading_crystal_item");
		}
